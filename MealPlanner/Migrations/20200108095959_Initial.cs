    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0.29999999999999999, 5.5999999999999996, "califlower", 4.0 },
                    { 2, 4.2000000000000002, 4.0, "nuts", 5.0 },
                    { 3, 3.2000000000000002, 1.0, "soy sauce", 5.0 },
                    { 4, 2.3999999999999999, 1.0, "egg white", 5.0 }
                });

            migrationBuilder.InsertData(
                table: "Meals",
                columns: new[] { "MealId", "CategoryId", "ImageThumbnailUrl", "ImageUrl", "IsMealOfTheWeek", "ItemMealPlanId", "LongDescription", "Name", "PreparationTime", "ShortDescription" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 15, 141.0, 4, 9 },
                    { 16, 211.0, 1, 9 },
                    { 9, 321.10000000000002, 2, 10 },
                    { 10, 12.1, 3, 10 },
                    { 11, 212.0, 4, 10 },
                    { 12, 101.0, 1, 10 },
                    { 29, 261.0, 2, 5 },
                    { 30, 261.0, 3, 5 },
                    { 7, 213.30000000000001, 3, 11 },
                    { 8, 122.2, 1, 11 }
                });
