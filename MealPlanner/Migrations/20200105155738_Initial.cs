        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingredients_IngredientDetails_IngredientDetailId",
                        column: x => x.IngredientDetailId,
            ...
            migrationBuilder.InsertData(
                table: "Ingredients",
                columns: new[] { "IngredientId", "Amount", "Calories", "CarbohidrateContent", "FatContent", "IngredientDetailId", "Name", "ProteinContent" },
                values: new object[,]
                {
                    { 1, 3.3999999999999999, 24, 0.29999999999999999, 1.0, 1, "califlower", 4.0 },
                    { 2, 1.8999999999999999, 24, 0.29999999999999999, 4.0, 2, "nuts", 5.0 },
                    { 3, 1.8999999999999999, 24, 1.3, 1.0, 3, "soy sauce", 5.0 },
                    { 4, 1.8999999999999999, 24, 0.29999999999999999, 1.0, 4, "egg white", 5.0 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredients_IngredientDetailId",
                table: "Ingredients",
                column: "IngredientDetailId",
                unique: true);
